...
def test_resolve_template_dirs_priority() -> None:
    ...
    with patch("inspect.getfile") as mock_getfile, \
        ...
        # Scenario: Operator defined in 'unittest', acting on 'code'
        ...
        dirs = svc._resolve_template_dirs(target_pop="code")
...
def test_resolve_template_dirs_fallback() -> None:
    ...
    with patch("inspect.getfile") as mock_getfile, \
        ...
        # Scenario: Operator defined in 'code', acting on 'code'
...
def test_relative_discovery_with_subclass() -> None:
    ...
    dirs = svc._resolve_template_dirs(target_pop=None)
    ...
    # but we can verify the 'Home' resolution logic was called for this class.
    with patch("inspect.getfile", wraps=inspect.getfile) as mock_getfile:
        svc._resolve_template_dirs(target_pop=None)
